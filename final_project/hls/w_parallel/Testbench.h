...
public:
	...
	sc_out < bool >  o_rst;
#ifndef NATIVE_SYSTEMC
	cynw_p2p< sc_dt::sc_uint<24> >::base_out o_rgbx;
	cynw_p2p< sc_dt::sc_uint<24> >::base_out o_rgby;
	cynw_p2p< sc_dt::sc_uint<24> >::base_out o_rgbz;
	cynw_p2p< sc_dt::sc_uint<8> >::base_in ir_result;
	cynw_p2p< sc_dt::sc_uint<8> >::base_in ig_result;
	cynw_p2p< sc_dt::sc_uint<8> >::base_in ib_result;
#else
	sc_fifo_out< sc_dt::sc_uint<24> > o_rgbx;
	sc_fifo_out< sc_dt::sc_uint<24> > o_rgby;
	sc_fifo_out< sc_dt::sc_uint<24> > o_rgbz;
	sc_fifo_in< sc_dt::sc_uint<8> > ir_result;
	sc_fifo_in< sc_dt::sc_uint<8> > ig_result;
	sc_fifo_in< sc_dt::sc_uint<8> > ib_result;
#endif
