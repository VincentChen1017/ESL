...
define_system_module ../SystemParallel.cpp

#
# SC_MODULEs to be synthesized
#
define_hls_module XColorTransform ../ColorTransform_x.cpp
define_hls_config XColorTransform BASIC
define_hls_config XColorTransform DPA       --dpopt_auto=op,expr

define_hls_module YColorTransform ../ColorTransform_y.cpp
define_hls_config YColorTransform BASIC
define_hls_config YColorTransform DPA       --dpopt_auto=op,expr

define_hls_module ZColorTransform ../ColorTransform_z.cpp
define_hls_config ZColorTransform BASIC
define_hls_config ZColorTransform DPA       --dpopt_auto=op,expr
...
foreach cfg { BASIC DPA } {
	...
	"YColorTransform RTL_V ${cfg}" \
	"XColorTransform RTL_V ${cfg}" \
	"ZColorTransform RTL_V ${cfg}" \
