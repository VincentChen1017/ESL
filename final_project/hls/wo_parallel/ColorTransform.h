...
public:
	...
	cynw_p2p< sc_dt::sc_uint<2> >::in rgb_select;
	cynw_p2p< sc_dt::sc_uint<8> >::out o;
#else
	sc_fifo_in< sc_dt::sc_uint<24> > i_rgb;
	sc_fifo_in< sc_dt::sc_uint<2> > rgb_select;
	sc_fifo_out< sc_dt::sc_uint<8> > o;
