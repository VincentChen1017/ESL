...
#include "ColorTransfer_P1B_0.h"
#include "ColorTransfer_P1B_1.h"
#include "ColorTransfer_P1G_0.h"
#include "ColorTransfer_P1G_1.h"
#include "ColorTransfer_P1R_0.h"
#include "ColorTransfer_P1R_1.h"
#include "ColorTransfer_P2B_0.h"
#include "ColorTransfer_P2B_1.h"
#include "ColorTransfer_P2G_0.h"
#include "ColorTransfer_P2G_1.h"
#include "ColorTransfer_P2R_0.h"
#include "ColorTransfer_P2R_1.h"
...
class BasicOptions : public Options {
   public:
	...
	addr_t colorTransfer_P1R_0_start_addr = 0x73000000;
	addr_t colorTransfer_P1R_0_size = 0x00100000;
	addr_t colorTransfer_P1R_0_end_addr = colorTransfer_P1R_0_start_addr + colorTransfer_P1R_0_size - 1;
	addr_t colorTransfer_P1R_1_start_addr = 0x73100000;
	addr_t colorTransfer_P1R_1_size = 0x00100000;
	;
	addr_t colorTransfer_P1R_1_end_addr = colorTransfer_P1R_1_start_addr + colorTransfer_P1R_1_size - 1;

	addr_t colorTransfer_P1G_0_start_addr = 0x73200000;
	addr_t colorTransfer_P1G_0_size = 0x00100000;
	addr_t colorTransfer_P1G_0_end_addr = colorTransfer_P1G_0_start_addr + colorTransfer_P1G_0_size - 1;
	addr_t colorTransfer_P1G_1_start_addr = 0x73300000;
	addr_t colorTransfer_P1G_1_size = 0x00100000;
	addr_t colorTransfer_P1G_1_end_addr = colorTransfer_P1G_1_start_addr + colorTransfer_P1G_1_size - 1;

	addr_t colorTransfer_P1B_0_start_addr = 0x73400000;
	addr_t colorTransfer_P1B_0_size = 0x00100000;
	addr_t colorTransfer_P1B_0_end_addr = colorTransfer_P1B_0_start_addr + colorTransfer_P1B_0_size - 1;
	addr_t colorTransfer_P1B_1_start_addr = 0x73500000;
	addr_t colorTransfer_P1B_1_size = 0x00100000;
	addr_t colorTransfer_P1B_1_end_addr = colorTransfer_P1B_1_start_addr + colorTransfer_P1B_1_size - 1;

	addr_t colorTransfer_P2R_0_start_addr = 0x73600000;
	addr_t colorTransfer_P2R_0_size = 0x00100000;
	addr_t colorTransfer_P2R_0_end_addr = colorTransfer_P2R_0_start_addr + colorTransfer_P2R_0_size - 1;
	addr_t colorTransfer_P2R_1_start_addr = 0x73700000;
	addr_t colorTransfer_P2R_1_size = 0x00100000;
	addr_t colorTransfer_P2R_1_end_addr = colorTransfer_P2R_1_start_addr + colorTransfer_P2R_1_size - 1;

	addr_t colorTransfer_P2G_0_start_addr = 0x73800000;
	addr_t colorTransfer_P2G_0_size = 0x00100000;
	addr_t colorTransfer_P2G_0_end_addr = colorTransfer_P2G_0_start_addr + colorTransfer_P2G_0_size - 1;
	addr_t colorTransfer_P2G_1_start_addr = 0x73900000;
	addr_t colorTransfer_P2G_1_size = 0x00100000;
	addr_t colorTransfer_P2G_1_end_addr = colorTransfer_P2G_1_start_addr + colorTransfer_P2G_1_size - 1;

	addr_t colorTransfer_P2B_0_start_addr = 0x73a00000;
	addr_t colorTransfer_P2B_0_size = 0x00100000;
	addr_t colorTransfer_P2B_0_end_addr = colorTransfer_P2B_0_start_addr + colorTransfer_P2B_0_size - 1;
	addr_t colorTransfer_P2B_1_start_addr = 0x73b00000;
	addr_t colorTransfer_P2B_1_size = 0x00100000;
	addr_t colorTransfer_P2B_1_end_addr = colorTransfer_P2B_1_start_addr + colorTransfer_P2B_1_size - 1;
	...
	void parse(int argc, char **argv) override {
		...
		assert((mem_end_addr < clint_start_addr || mem_start_addr > colorTransfer_P2B_1_end_addr) &&
...
int sc_main(int argc, char **argv) {
	...
	COLORTRANSFER_P1B_0 color_transfer_p1b_0("color_transfer_p1b_0");
	COLORTRANSFER_P1G_0 color_transfer_p1g_0("color_transfer_p1g_0");
	COLORTRANSFER_P1R_0 color_transfer_p1r_0("color_transfer_p1r_0");
	COLORTRANSFER_P2B_0 color_transfer_p2b_0("color_transfer_p2b_0");
	COLORTRANSFER_P2G_0 color_transfer_p2g_0("color_transfer_p2g_0");
	COLORTRANSFER_P2R_0 color_transfer_p2r_0("color_transfer_p2r_0");
	COLORTRANSFER_P1B_1 color_transfer_p1b_1("color_transfer_p1b_1");
	COLORTRANSFER_P1G_1 color_transfer_p1g_1("color_transfer_p1g_1");
	COLORTRANSFER_P1R_1 color_transfer_p1r_1("color_transfer_p1r_1");
	COLORTRANSFER_P2B_1 color_transfer_p2b_1("color_transfer_p2b_1");
	COLORTRANSFER_P2G_1 color_transfer_p2g_1("color_transfer_p2g_1");
	COLORTRANSFER_P2R_1 color_transfer_p2r_1("color_transfer_p2r_1");
	...
	bus.ports[12] = new PortMapping(opt.colorTransfer_P1R_0_start_addr, opt.colorTransfer_P1R_0_end_addr);
	bus.ports[13] = new PortMapping(opt.colorTransfer_P1G_0_start_addr, opt.colorTransfer_P1G_0_end_addr);
	bus.ports[14] = new PortMapping(opt.colorTransfer_P1B_0_start_addr, opt.colorTransfer_P1B_0_end_addr);
	bus.ports[15] = new PortMapping(opt.colorTransfer_P2R_0_start_addr, opt.colorTransfer_P2R_0_end_addr);
	bus.ports[16] = new PortMapping(opt.colorTransfer_P2G_0_start_addr, opt.colorTransfer_P2G_0_end_addr);
	bus.ports[17] = new PortMapping(opt.colorTransfer_P2B_0_start_addr, opt.colorTransfer_P2B_0_end_addr);
	bus.ports[18] = new PortMapping(opt.colorTransfer_P1R_1_start_addr, opt.colorTransfer_P1R_1_end_addr);
	bus.ports[19] = new PortMapping(opt.colorTransfer_P1G_1_start_addr, opt.colorTransfer_P1G_1_end_addr);
	bus.ports[20] = new PortMapping(opt.colorTransfer_P1B_1_start_addr, opt.colorTransfer_P1B_1_end_addr);
	bus.ports[21] = new PortMapping(opt.colorTransfer_P2R_1_start_addr, opt.colorTransfer_P2R_1_end_addr);
	bus.ports[22] = new PortMapping(opt.colorTransfer_P2G_1_start_addr, opt.colorTransfer_P2G_1_end_addr);
	bus.ports[23] = new PortMapping(opt.colorTransfer_P2B_1_start_addr, opt.colorTransfer_P2B_1_end_addr);
	...
	bus.isocks[12].bind(color_transfer_p1r_0.tsock);
	bus.isocks[13].bind(color_transfer_p1g_0.tsock);
	bus.isocks[14].bind(color_transfer_p1b_0.tsock);
	bus.isocks[15].bind(color_transfer_p2r_0.tsock);
	bus.isocks[16].bind(color_transfer_p2g_0.tsock);
	bus.isocks[17].bind(color_transfer_p2b_0.tsock);
	bus.isocks[18].bind(color_transfer_p1r_1.tsock);
	bus.isocks[19].bind(color_transfer_p1g_1.tsock);
	bus.isocks[20].bind(color_transfer_p1b_1.tsock);
	bus.isocks[21].bind(color_transfer_p2r_1.tsock);
	bus.isocks[22].bind(color_transfer_p2g_1.tsock);
	bus.isocks[23].bind(color_transfer_p2b_1.tsock);
	...
	if (opt.use_debug_runner) {
		...
		new GDBServerRunner("GDBRunner0", server, &core2);
	} else {
