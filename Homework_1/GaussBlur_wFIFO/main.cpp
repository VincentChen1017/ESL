...
int sc_main(int argc, char **argv)
{
  ...
  Testbench tb("tb");
  GaussBlurFilter gaussblur_filter("gaussblur_filter");
  ...
  tb.i_clk(clk);
  tb.o_rst(rst);
  gaussblur_filter.i_clk(clk);
  gaussblur_filter.i_rst(rst);
  tb.o_r(r);
  tb.o_g(g);
  tb.o_b(b);
  ...
  gaussblur_filter.i_r(r);
  gaussblur_filter.i_g(g);
  gaussblur_filter.i_b(b);
  gaussblur_filter.or_result(r_result);
  gaussblur_filter.og_result(g_result);
  gaussblur_filter.ob_result(b_result);
